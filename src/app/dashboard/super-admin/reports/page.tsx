    ...
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-3xl border border-slate-200 shadow-sm">
        <div>
          ...
          <h1 className="text-3xl font-bold text-slate-950 mt-4">Manage Reports</h1>
          <p className="text-sm text-slate-500 mt-2">Overview of all reports records on the platform.</p>
        </div>
      </div>
      ...
      <div className="bg-white border text-sm border-slate-200 rounded-3xl overflow-hidden shadow-sm">
        {loading ? (
           ...
           <div className="p-10 text-center text-slate-500">No reports found in database.</div>
        ) : (
